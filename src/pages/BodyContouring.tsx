  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="animate-fade3d">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 text-black text-3d hover-scale3d">
                Body Contouring
              </h1>
            </div>
            <div className="animate-fade3d" style={{ animationDelay: '0.5s' }}>
              <button className="bg-black text-white px-8 py-4 rounded-full font-semibold hover:bg-gray-800 transition-all duration-300 text-lg transform hover:scale-105 hover:-translate-y-1 liquid btn-3d animate-float3d">
                BOOK YOUR TREATMENT
              </button>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade3d">
              <img
                src="/images/body-contouring-treatment-mob_1.png.webp"
                alt="Body Contouring Treatment"
                className="w-full h-96 object-cover rounded-lg shadow-lg img-3d"
              />
            </div>
            
            <div className="animate-fade3d" style={{ animationDelay: '0.5s' }}>
              <h2 className="text-3xl font-bold mb-6 text-black text-3d hover-scale3d">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-black animate-fade3d text-3d hover-scale3d">
            Choose the body contouring treatment that works for you
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* INDIBA Body Contouring */}
            <div className="animate-slide3d">
              <div className="bg-white rounded-lg overflow-hidden shadow-lg card-3d">
                <div className="relative">
                  <img
                    src="/images/body-contouring-treatment-mob_1.png.webp"
                    alt="INDIBA Body Contouring"
                    className="w-full h-48 object-cover img-3d"
                  />
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-4 text-black text-3d">INDIBA Body Contouring</h3>
            ...
            <div className="animate-slide3d" style={{ animationDelay: '0.2s' }}>
              <div className="bg-white rounded-lg overflow-hidden shadow-lg card-3d">
                <div className="relative">
                  <img
                    src="/images/body-contouring-treatment-mob_1.png.webp"
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-4 text-black text-3d">InFlex Body Sculpting</h3>
                  <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            {/* Body Contouring */}
            <div className="animate-slide3d" style={{ animationDelay: '0.4s' }}>
              <div className="bg-white rounded-lg overflow-hidden shadow-lg card-3d">
                <div className="relative">
                  <img
                    src="/images/body-contouring-treatment-mob_1.png.webp"
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-4 text-black text-3d">Body Contouring</h3>
                  <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto animate-fade-in-up">
            <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed italic">
                "I've just finished my body countour treatment with Truflex and Indiba and couldn't be any happier with the results. 
                Not only my tummy and legs are firmer, but also slimmer and better shaped. I extremely enjoyed the sessions. 
                Claudia is an outstanding professional who adapted each session and designed a specific protocol to my specific needs. 
                Highly recommended!"
              </p>
              <h4 className="text-xl font-bold text-black">A GR</h4>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-in-up">
            <p className="text-sm text-gray-300 mb-2">Not sure what treatment to choose?</p>
            <h2 className="text-3xl font-bold mb-4 text-white">Book a free body consultation</h2>
            <p className="text-gray-300 mb-8">Our experts will assess your needs and recommend the perfect treatment plan for your goals</p>
            <button className="bg-white text-black px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 text-lg transform hover:scale-105">
              BOOK NOW
            </button>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4 text-black animate-fade-in-up">
            How Body Contouring can help?
          </h2>
          <p className="text-gray-600 text-center mb-12">Get answers to common questions about our advanced body contouring treatments</p>
