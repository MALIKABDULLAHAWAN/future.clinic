        ...
        <div className="container-custom">
          <div className="text-center animate-fade-in-up">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-4xl mx-auto leading-relaxed">
              Advanced ultrasound technology for non-surgical lifting and tightening treatments.
            </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                We're working on creating a comprehensive page for Ultraformer MPT treatments. 
                This advanced technology offers non-surgical lifting and tightening solutions.
              </p>
              <div className="bg-gray-50 p-8 rounded-lg">
                <h3 className="text-2xl font-bold mb-4 text-black">Ultraformer MPT Features</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  <div className="text-center">
                    <Shield className="w-12 h-12 text-black mx-auto mb-4" />
                    <h4 className="text-lg font-bold mb-2 text-black">Non-Surgical</h4>
                    <p className="text-gray-700">Advanced ultrasound technology for lifting</p>
                  </div>
                  <div className="text-center">
                    <Clock className="w-12 h-12 text-black mx-auto mb-4" />
                    <h4 className="text-lg font-bold mb-2 text-black">Quick Treatment</h4>
                    <p className="text-gray-700">Fast and effective treatment sessions</p>
                  </div>
                  <div className="text-center">
                    <Heart className="w-12 h-12 text-black mx-auto mb-4" />
                    <h4 className="text-lg font-bold mb-2 text-black">Natural Results</h4>
                    <p className="text-gray-700">Stimulates natural collagen production</p>
                  </div>
                </div>
              </div>
            </div>
